...
local AIControlsScreen = Class(Screen, function(self, modname, options_screen)
	Screen._ctor(self, "AIControlsScreen")
	...
	self.bg = self.proot:AddChild(TEMPLATES.RectangleWindow(619, 359, "AI Keybinds", bottom_buttons))
...
function AIControlsScreen:SetUpFocusHookups()

end

function AIControlsScreen:GetHelpText()
...
function AIControlsScreen:OnRawKey(key, down)
	if AIControlsScreen._base.OnRawKey(self, key, down) then return true end
...
function AIControlsScreen:OnControl(control, down)
	if AIControlsScreen._base.OnControl(self,control, down) then return true end
...
function AIControlsScreen:MapControl(group)
...
function AIControlsScreen:Close()
...
function AIControlsScreen:SaveChanges()
...
function AIControlsScreen:Apply()
	self:SaveChanges()
	self:Close()
end

function AIControlsScreen:Reset()
	local function callback_yes()
		for _, group in pairs(self.groups) do
...
function AIControlsScreen:Confirm(title, body, callback_yes, callback_no)
...
function AIControlsScreen:GetKeyText(key)
...
function AIControlsScreen:OnBecomeActive()
	AIControlsScreen._base.OnBecomeActive(self)
